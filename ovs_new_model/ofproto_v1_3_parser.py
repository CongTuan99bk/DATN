...
@_register_parser
@_set_msg_type(ofproto.OFPT_FLAG)
class OFPFlag(MsgBase):
    def __init__(self, datapath, elements=None):
        elements = elements if elements else []
        super(OFPFlag, self).__init__(datapath)
        self.elements = elements

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        msg = super(OFPFlag, cls).parser(datapath, version, msg_type,
                                          msg_len, xid, buf)
...
class OFPAnomalyDetection_O(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data12.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        #print("Anomaly Detect!!!")
        # subprocess.call("/home/fil02/tuan/lof_capture.sh")
...
class OFPAnomalyDetection_T_O(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data21.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/iot_team/6sw_fil_master/6sw_test/result/data21.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
class OFPAnomalyDetection_T_T(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data22.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        #print("Anomaly Detect!!!")
        # subprocess.call("/home/fil02/tuan/lof_capture.sh")
...
class OFPAnomalyDetection_TH_O(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data31.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/iot_team/6sw_fil_master/6sw_test/result/data31.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
class OFPAnomalyDetection_TH_T(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data32.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        #print("Anomaly Detect!!!")
        # subprocess.call("/home/fil02/tuan/lof_capture.sh")
...
class OFPAnomalyDetection_FO_O(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data41.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/iot_team/6sw_fil_master/6sw_test/result/data41.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
class OFPAnomalyDetection_FO_T(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data42.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/iot_team/6sw_fil_master/6sw_test/result/data42.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
class OFPAnomalyDetection_FO_TH(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data43.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/iot_team/6sw_fil_master/6sw_test/result/data43.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
class OFPAnomalyDetection_FO_F(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data44.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        # with open("/home/iot_team/6sw_fil_master/6sw_test/result/data44.txt", "a+") as f:
        #     f.seek(0)
        #     data = f.read(30)
        #     if len(data) > 0:
        #         f.write("\n")
...
class OFPAnomalyDetection_FI_O(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data51.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/iot_team/6sw_fil_master/6sw_test/result/data51.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
class OFPAnomalyDetection_FI_T(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data52.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/iot_team/6sw_fil_master/6sw_test/result/data52.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
class OFPAnomalyDetection_FI_TH(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data53.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        # with open("/home/iot_team/6sw_fil_master/6sw_test/result/data53.txt", "a+") as f:
        #     f.seek(0)
        #     data = f.read(30)
        #     if len(data) > 0:
        #         f.write("\n")
...
class OFPAnomalyDetection_SI_O(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data61.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        # #print("Anomaly Detect!!!")
        # subprocess.call("/home/fil02/tuan/lof_capture.sh")
...
class OFPAnomalyDetection_SI_T(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data62.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/iot_team/6sw_fil_master/6sw_test/result/data62.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
class OFPAnomalyDetection_SI_TH(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        # f = open("/home/iot_team/6sw_fil_master/6sw_test/result/data63.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/iot_team/6sw_fil_master/6sw_test/result/data63.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
